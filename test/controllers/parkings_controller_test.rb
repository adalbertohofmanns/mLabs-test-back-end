...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { left: @parking.left, paid: @parking.paid, plate: @parking.plate, time: @parking.time } }, as: :json
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { left: @parking.left, paid: @parking.paid, plate: @parking.plate, time: @parking.time } }, as: :json
    assert_response 200
  end
